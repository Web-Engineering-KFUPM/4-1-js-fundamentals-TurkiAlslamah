...
const SCHOOL = "MyCollege";
//SCHOOL = "OtherCollege"; // This line will cause an error because constants cannot be reassigned.
console.log(SCHOOL);
...
// The first two concatenate because when one operand is a string, JavaScript converts the other operand to a string and performs concatenation.
...
//         - "Aged" if age > 35
// write code here
let age = 25; // Example age, you can change this value to test different outputs
if (age < 13) {
    console.log("Child");
